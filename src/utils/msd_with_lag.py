...
def main(args):
    ...
    for i in range(len(time_frames[:-1])):
         ...
         delta_x_1.append(atom_1[atom_1['time_frames'] == time_frames[i+1]]['x'].values - atom_1[atom_1['time_frames'] == time_frames[i]]['x'].values)
         delta_x_2.append(atom_2[atom_2['time_frames'] == time_frames[i+1]]['x'].values - atom_2[atom_2['time_frames'] == time_frames[i]]['x'].values)
